...
public class RectangleRunner {
    public static void main(String[] args) {
        ...
        double boxVolume1 = rect1.calculateBoxVolume(rect1Height);
        System.out.println("Rectangle 1's Area" + area1 + ", Box Volume:" + boxVolume1);

        Rectangle rect2 = new Rectangle(rect2Length, rect2Width);
        int area2 = rect2.calculateArea();
        double boxVolume2 = rect2.calculateBoxVolume(rect2Height);
        System.out.println("Rectangle 2's Area" + area2 + ", Box Volume:" + boxVolume2);
    }
}
